...
REQ_NAMES  = ["R0", "R1", "R2", "R3", "R4", "R5"]   # ADAS2 has 6 requirements
N_REQ      = len(REQ_NAMES)
...
def load_run(run_dir):
    """Load per-evaluation requirement satisfaction. Returns violated matrix (1=violated)."""
...
fig.suptitle(
    ...
    "(lower = found earlier; 'never' = requirement never violated in that run;\n"
