...
system(paste("pdfcrop --margins '0 0 0 0' imgs/violations.pdf", "imgs/b3_violations.pdf", sep = " "))
...
p <- ggplot(df, aes(x = variable, 
    ...
    scale_y_continuous(breaks = seq(-0.08, 0.06, 0.04)) +
    theme_bw() +
...
system(paste("pdfcrop --margins '0 0 0 0' imgs/scores.pdf", "imgs/b3_scores.pdf", sep = " "))
